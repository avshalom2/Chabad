...
<svg xmlns="http://www.w3.org/2000/svg" width="${IMAGE_WIDTH}" height="${IMAGE_HEIGHT}" viewBox="0 0 ${IMAGE_WIDTH} ${IMAGE_HEIGHT}" direction="rtl" color-scheme="only light" style="color-scheme: only light; background: #ffffff;">
  <defs>
    <style>
      :root,
      svg,
